...
public class Workshop_regestier extends AppCompatActivity {
                ...
                fAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(Workshop_regestier.this, "User Created ", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(Workshop_regestier.this, "Error !"+task.getException().getMessage(), Toast.LENGTH_SHORT).show();
